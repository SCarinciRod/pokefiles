...
ability_keyword("adaptability").
ability_keyword("aerilate").
ability_keyword("aftermath").
ability_keyword("air_lock").
ability_keyword("analytic").
...
ability_keyword("as_one_glastrier").
ability_keyword("as_one_spectrier").
ability_keyword("aura_break").
ability_keyword("bad_dreams").
ability_keyword("ball_fetch").
ability_keyword("battery").
ability_keyword("battle_armor").
ability_keyword("battle_bond").
ability_keyword("beads_of_ruin").
...
ability_keyword("cotton_down").
ability_keyword("cud_chew").
ability_keyword("curious_medicine").
ability_keyword("cursed_body").
ability_keyword("cute_charm").
ability_keyword("damp").
...
ability_keyword("drought").
ability_keyword("dry_skin").
ability_keyword("early_bird").
ability_keyword("earth_eater").
ability_keyword("effect_spore").
ability_keyword("electric_surge").
...
ability_keyword("galvanize").
ability_keyword("gluttony").
...
ability_keyword("hydration").
ability_keyword("hyper_cutter").
ability_keyword("ice_body").
ability_keyword("ice_face").
ability_keyword("ice_scales").
ability_keyword("illuminate").
ability_keyword("illusion").
ability_keyword("immunity").
ability_keyword("imposter").
ability_keyword("infiltrator").
...
ability_keyword("lingering_aroma").
...
ability_keyword("mummy").
ability_keyword("mycelium_might").
ability_keyword("natural_cure").
...
ability_keyword("pixilate").
ability_keyword("plus").
ability_keyword("poison_heal").
ability_keyword("poison_point").
...
ability_keyword("protean").
ability_keyword("protosynthesis").
ability_keyword("psychic_surge").
ability_keyword("punk_rock").
ability_keyword("pure_power").
ability_keyword("purifying_salt").
ability_keyword("quark_drive").
ability_keyword("queenly_majesty").
ability_keyword("quick_draw").
ability_keyword("quick_feet").
ability_keyword("rain_dish").
ability_keyword("rattled").
ability_keyword("receiver").
ability_keyword("reckless").
ability_keyword("refrigerate").
ability_keyword("regenerator").
ability_keyword("ripen").
ability_keyword("rivalry").
ability_keyword("rks_system").
ability_keyword("rock_head").
...
ability_keyword("sniper").
ability_keyword("snow_cloak").
ability_keyword("snow_warning").
ability_keyword("solar_power").
ability_keyword("solid_rock").
...
ability_keyword("stench").
ability_keyword("sticky_hold").
ability_keyword("storm_drain").
ability_keyword("strong_jaw").
ability_keyword("sturdy").
ability_keyword("suction_cups").
ability_keyword("super_luck").
ability_keyword("supersweet_syrup").
ability_keyword("supreme_overlord").
ability_keyword("surge_surfer").
ability_keyword("swarm").
ability_keyword("sweet_veil").
ability_keyword("swift_swim").
ability_keyword("sword_of_ruin").
ability_keyword("symbiosis").
ability_keyword("synchronize").
ability_keyword("tablets_of_ruin").
ability_keyword("tangled_feet").
...
ability_keyword("toxic_boost").
ability_keyword("toxic_chain").
ability_keyword("toxic_debris").
ability_keyword("trace").
ability_keyword("transistor").
ability_keyword("triage").
ability_keyword("truant").
ability_keyword("turboblaze").
ability_keyword("unaware").
...
ability_keyword("wimp_out").
ability_keyword("wind_power").
ability_keyword("wind_rider").
ability_keyword("wonder_guard").
ability_keyword("wonder_skin").
ability_keyword("zen_mode").
ability_keyword("zero_to_hero").
...
ability_keyword_phrase(["as", "one", "glastrier"]).
ability_keyword_phrase(["as", "one", "spectrier"]).
ability_keyword_phrase(["aura", "break"]).
ability_keyword_phrase(["bad", "dreams"]).
ability_keyword_phrase(["ball", "fetch"]).
ability_keyword_phrase(["battle", "armor"]).
ability_keyword_phrase(["battle", "bond"]).
...
ability_keyword_phrase(["cloud", "nine"]).
ability_keyword_phrase(["color", "change"]).
ability_keyword_phrase(["compound", "eyes"]).
ability_keyword_phrase(["cotton", "down"]).
ability_keyword_phrase(["cud", "chew"]).
ability_keyword_phrase(["curious", "medicine"]).
ability_keyword_phrase(["cursed", "body"]).
...
ability_keyword_phrase(["dry", "skin"]).
ability_keyword_phrase(["early", "bird"]).
ability_keyword_phrase(["earth", "eater"]).
ability_keyword_phrase(["effect", "spore"]).
ability_keyword_phrase(["electric", "surge"]).
ability_keyword_phrase(["embody", "aspect"]).
...
ability_keyword_phrase(["flower", "veil"]).
ability_keyword_phrase(["friend", "guard"]).
ability_keyword_phrase(["full", "metal", "body"]).
ability_keyword_phrase(["fur", "coat"]).
...
ability_keyword_phrase(["guard", "dog"]).
...
ability_keyword_phrase(["ice", "body"]).
ability_keyword_phrase(["ice", "face"]).
ability_keyword_phrase(["ice", "scales"]).
ability_keyword_phrase(["innards", "out"]).
ability_keyword_phrase(["inner", "focus"]).
...
ability_keyword_phrase(["liquid", "ooze"]).
ability_keyword_phrase(["liquid", "voice"]).
ability_keyword_phrase(["long", "reach"]).
ability_keyword_phrase(["magic", "bounce"]).
ability_keyword_phrase(["magic", "guard"]).
ability_keyword_phrase(["magma", "armor"]).
ability_keyword_phrase(["magnet", "pull"]).
ability_keyword_phrase(["marvel", "scale"]).
ability_keyword_phrase(["mega", "launcher"]).
ability_keyword_phrase(["minds", "eye"]).
...
ability_keyword_phrase(["neutralizing", "gas"]).
ability_keyword_phrase(["no", "guard"]).
ability_keyword_phrase(["orichalcum", "pulse"]).
ability_keyword_phrase(["own", "tempo"]).
ability_keyword_phrase(["parental", "bond"]).
ability_keyword_phrase(["pastel", "veil"]).
ability_keyword_phrase(["perish", "body"]).
ability_keyword_phrase(["poison", "heal"]).
ability_keyword_phrase(["poison", "point"]).
...
ability_keyword_phrase(["prism", "armor"]).
ability_keyword_phrase(["propeller", "tail"]).
ability_keyword_phrase(["psychic", "surge"]).
ability_keyword_phrase(["punk", "rock"]).
ability_keyword_phrase(["pure", "power"]).
ability_keyword_phrase(["purifying", "salt"]).
ability_keyword_phrase(["quark", "drive"]).
ability_keyword_phrase(["queenly", "majesty"]).
ability_keyword_phrase(["quick", "draw"]).
ability_keyword_phrase(["quick", "feet"]).
ability_keyword_phrase(["rain", "dish"]).
ability_keyword_phrase(["rks", "system"]).
ability_keyword_phrase(["rock", "head"]).
...
ability_keyword_phrase(["sand", "stream"]).
ability_keyword_phrase(["sand", "veil"]).
ability_keyword_phrase(["sap", "sipper"]).
...
ability_keyword_phrase(["sheer", "force"]).
ability_keyword_phrase(["shell", "armor"]).
ability_keyword_phrase(["shield", "dust"]).
ability_keyword_phrase(["shields", "down"]).
ability_keyword_phrase(["skill", "link"]).
ability_keyword_phrase(["slow", "start"]).
ability_keyword_phrase(["slush", "rush"]).
ability_keyword_phrase(["snow", "cloak"]).
ability_keyword_phrase(["snow", "warning"]).
ability_keyword_phrase(["solar", "power"]).
ability_keyword_phrase(["solid", "rock"]).
ability_keyword_phrase(["soul", "heart"]).
ability_keyword_phrase(["speed", "boost"]).
ability_keyword_phrase(["stance", "change"]).
ability_keyword_phrase(["steam", "engine"]).
ability_keyword_phrase(["steely", "spirit"]).
ability_keyword_phrase(["sticky", "hold"]).
ability_keyword_phrase(["storm", "drain"]).
ability_keyword_phrase(["strong", "jaw"]).
ability_keyword_phrase(["suction", "cups"]).
ability_keyword_phrase(["super", "luck"]).
ability_keyword_phrase(["supersweet", "syrup"]).
ability_keyword_phrase(["supreme", "overlord"]).
ability_keyword_phrase(["surge", "surfer"]).
ability_keyword_phrase(["sweet", "veil"]).
ability_keyword_phrase(["swift", "swim"]).
ability_keyword_phrase(["sword", "of", "ruin"]).
ability_keyword_phrase(["tablets", "of", "ruin"]).
ability_keyword_phrase(["tangled", "feet"]).
ability_keyword_phrase(["tangling", "hair"]).
ability_keyword_phrase(["tera", "shell"]).
ability_keyword_phrase(["tera", "shift"]).
ability_keyword_phrase(["teraform", "zero"]).
ability_keyword_phrase(["thermal", "exchange"]).
ability_keyword_phrase(["thick", "fat"]).
ability_keyword_phrase(["tinted", "lens"]).
ability_keyword_phrase(["tough", "claws"]).
ability_keyword_phrase(["toxic", "boost"]).
ability_keyword_phrase(["toxic", "chain"]).
ability_keyword_phrase(["toxic", "debris"]).
ability_keyword_phrase(["unseen", "fist"]).
ability_keyword_phrase(["vessel", "of", "ruin"]).
ability_keyword_phrase(["victory", "star"]).
...
ability_keyword_phrase(["wimp", "out"]).
ability_keyword_phrase(["wind", "power"]).
ability_keyword_phrase(["wind", "rider"]).
ability_keyword_phrase(["wonder", "guard"]).
ability_keyword_phrase(["wonder", "skin"]).
ability_keyword_phrase(["zen", "mode"]).
ability_keyword_phrase(["zero", "to", "hero"]).
